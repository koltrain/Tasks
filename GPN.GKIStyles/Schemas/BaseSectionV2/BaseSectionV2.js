define("BaseSectionV2", ["GKIHTMLControlGenerator", "GKIHTMLControl", "css!GKIGPNStyles"], function () {
    return {
        messages: {},
        attributes: {
            "GKIHTMLFull": {
        ...
        methods: {
            onGridDataLoaded: function (response) {
                ...
                this.set("GKIHTMLFull", "<div class='new-captions'></div>");
                    ...
                    if (profile.DataGrid) {
                        ...
                        if (dataGrid && dataGrid.isTiled !== undefined) {
                            ...
                            if (gridsColumnsConfig) {
                                ...
                                this.set("GKIHTMLFull", "<div class='new-captions'><div class='grid-captions'>" + captionsHTMl + "</div></div>");
                            }
                        }
                    }
                }
            ...
            getMyParam2: function () {
                return this.get("GKIHTMLFull");
            },
            myMethod2: function (json) {
                if (json) {
                    this.set("GKIHTMLFull", json);
                } else {
                    this.set("GKIHTMLFull", "");
                }
            },
        ...
        diff: [
            {
                ...
                "values": {
                    ...
                    "generator": "GKIHTMLControlGenerator.generateGKIHTMLControl",
