define("GKILicUserPage", ["ServiceHelper", "ProcessModuleUtilities", "RightUtilities", "GKILicensingConstantsJs"],
    function (ServiceHelper, ProcessModuleUtilities, RightUtilities, constants) {
        return {
            ...
            methods: {
                ...
                /**
                * @public
				* фильтр детали Лицензии пользователя
                * returns {Object} filterGroup
                */
                licFilter: function () {
                ...
                /**
                 * @overridden
				 * действия при инициализации карточки
                 */
                init: function () {
                    this.callParent(arguments);
