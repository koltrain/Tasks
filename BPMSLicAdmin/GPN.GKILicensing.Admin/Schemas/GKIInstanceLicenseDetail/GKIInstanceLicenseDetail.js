define("GKIInstanceLicenseDetail", ["BusinessRulesApplierV2", "ConfigurationGrid", "ConfigurationGridGenerator", "ConfigurationGridUtilities"], 
		...
		methods: {
			...
			generateActiveRowControlsConfig: function(id, columnsConfig, rowConfig) {
				...
				this.Terrasoft.each(columnsConfig, function(columnConfig) {
					...
					//Лимит лицензии приложения - целое число 
					//Лимит VIP пользователей - целое число 
					//(доступны для редактирования)
					//остальные поля недоступны
					cellConfig.enabled = columnName === "GKILimit" ||
						columnName === "GKILimitVIP" ? true : false;
